...
func FetchAddress(c *fiber.Ctx) error {
	...
	//Calc offset and total pages
	offset, totalPage := utils.Paginate(page, pageSize, int(totalAddress))
	...
	//if addressess is nil, returns an empty slice
	if addresses == nil {
		addresses = models.AddressSlice{}
	}
